...
<html lang="en">
    <head>
        <title>Kaslo Sourdough Pasta | Bring Nutrition Home</title>
    ...
    <body>
        <div class="page-wrapper">
            ...
            <?php print file_get_contents('../content/kaslo-sourdough-pasta--hero--content.html'); ?>
            <?php print file_get_contents('../content/kaslo-sourdough-pasta--main--content.html'); ?>
