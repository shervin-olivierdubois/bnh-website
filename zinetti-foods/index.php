...
<html lang="en">
    <head>
        <title>Zinetti Foods | Bring Nutrition Home</title>
    ...
    <body>
        <div class="page-wrapper">
            ...
            <?php print file_get_contents('../content/zinetti-foods--hero--content.html'); ?>
            <?php print file_get_contents('../content/zinetti-foods--main--content.html'); ?>
