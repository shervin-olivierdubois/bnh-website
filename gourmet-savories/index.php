...
<html lang="en">
    <head>
        <title>Gourmet Savories | Bring Nutrition Home</title>
    ...
    <body>
        <div class="page-wrapper">
            ...
            <?php print file_get_contents('../content/gourmet-savories--hero--content.html'); ?>
            <?php print file_get_contents('../content/gourmet-savories--main--content.html'); ?>
